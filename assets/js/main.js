...
function updateProfessionalExperience(profileData) {
    const experienceList = document.getElementById("profile.experience");

    profileData.professionalExperience.length === 0 ?
    experienceList.innerHTML = `<h3 class="title">Sem experiência profissional</h3>` :  
    experienceList.innerHTML = profileData.professionalExperience.map(experience => {
        return `
            <li>
